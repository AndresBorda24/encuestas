...
/**
  ...
  *
  * @checksum - 5646e6da59070dda586d0e553bf95597328ddc57f454eb2f47de5c29d9cfda59
  * @variables - radius=rounded,accentColor=sky,colorTemperature=neutral,spacing=1.5,scale=sm,inputShadow=shadow,baseColorShade=500,borderShadeLightMode=400,borderShadeDarkMode=500,inputMaxWidth=max-w-none,tagRadius=rounded,swatchRadius=rounded
  * @theme - regenesis
  **/
