...
/**
  ...
  *
  * @checksum - 894030f15ee28cd8c9de67c2680e4477270aa63f90b4e94b22cbb5d39bd11b6c
  * @variables - radius=rounded,accentColor=blue,colorTemperature=neutral,spacing=1.5,scale=sm,inputShadow=shadow,baseColorShade=600,borderShadeLightMode=400,borderShadeDarkMode=500,inputMaxWidth=max-w-[20em],tagRadius=rounded,swatchRadius=rounded
  * @theme - regenesis
  **/
